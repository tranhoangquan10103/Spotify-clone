				...
				<div class="now-playing-section">
					<div class="now-playing-left">
						<div class="now-playing-cover">
							<img
								src="https://i.scdn.co/image/ab67616d000011eb838be058f3d9ade37d66054e"
								alt="Now playing cover"
								class="now-playing-img"
							/>
						</div>
						<div class="now-playing-info">
							<div class="now-playing-title">Too Sweet</div>
							<div class="now-playing-artist">Hozier</div>
						</div>
					</div>
					...
					<div class="now-playing-center">
						...
						<button v-tooltip.top="'Play'" class="player-btn player-play-btn" type="button" aria-label="Play">
							<img alt="Play" src="../assets/svg/play.svg">
						</button>
					...
					<div class="now-playing-progress-container">
						<span class="now-playing-time">0:16</span>
						<div class="now-playing-progress-bar">
							<div class="now-playing-progress-fill" style="width: 6.5%"></div>
							<div class="now-playing-progress-handle"></div>
						</div>
						<span class="now-playing-time">4:11</span>
					</div>
